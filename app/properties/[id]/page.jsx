        ...
        <>
          ...
          <section>
            <div className="container m-auto py-6 px-6">
              ...
              >
                <i className="fas fa-arrow-left mr-2" /> Back to Properties
              </Link>
            </div>
          </section>
                ...
                <main>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    ...
                    <div className="flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9">
                      <p>
                        <i className="fa-solid fa-bed" /> 3<span className="hidden sm:inline">Beds</span>
                      </p>
                      <p>
                        <i className="fa-solid fa-bath" /> 2<span className="hidden sm:inline">Baths</span>
                      </p>
                      <p>
                    ...
                    <p className="text-gray-500 mb-4">We have a beautiful apartment located near the commons. It is a 2 bedroom apartment with a full kitchen and bathroom. It is available for weekly or monthly rentals.</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    <h3 className="text-lg font-bold mb-6">Amenities</h3>
                    <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none">
                      <li>
                        <i className="fas fa-check text-green-600 mr-2 mt-3" /> Wifi
                      </li>
                      <li>
                        <i className="fas fa-check text-green-600 mr-2 mt-3" />
                        Full kitchen
                      </li>
                      <li>
                        <i className="fas fa-check text-green-600 mr-2 mt-3" />
